...
function Login() {
  ...
  useEffect(() => {
    GoogleAuth.initialize({
      clientId: '960550306965-tsc1go8io06cj32a4u1puodgef3k5hd8.apps.googleusercontent.com',
  ...
  return (
    <div className="login-container">
      <button className="login-back" onClick={() => navigate('/inicio')}>←</button>

      <h1>Inicia sesión</h1>

      <p className="login-subtitle">
        ¿No tienes una cuenta? <a onClick={() => navigate('/registro')}>Crear cuenta</a>
      </p>
      ...
      <div className="divisor">O inicia sesión con</div>
      ...
      <p className="login-info">
        Accede para ver tus solicitudes, favoritos, mensajes y perfil.
      </p>
    </div>
  );
}
